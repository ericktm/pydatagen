...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Table.created'
        db.add_column(u'app_table', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True,
                                                                       default=datetime.datetime(2014, 4, 10, 0, 0),
                                                                       blank=True),
                      keep_default=False)

        # Adding field 'Table.edited'
        db.add_column(u'app_table', 'edited',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Table.active'
        db.add_column(u'app_table', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Project.edited'
        db.alter_column(u'app_project', 'edited',
                        self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Project.created'
        db.alter_column(u'app_project', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Table.created'
        db.delete_column(u'app_table', 'created')

        # Deleting field 'Table.edited'
        db.delete_column(u'app_table', 'edited')

        # Deleting field 'Table.active'
        db.delete_column(u'app_table', 'active')


        # Changing field 'Project.edited'
        db.alter_column(u'app_project', 'edited', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Project.created'
        db.alter_column(u'app_project', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
