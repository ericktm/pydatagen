...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Table.insert'
        db.add_column(u'app_table', 'insert',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Table.quantity'
        db.add_column(u'app_table', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Table.insert'
        db.delete_column(u'app_table', 'insert')

        # Deleting field 'Table.quantity'
        db.delete_column(u'app_table', 'quantity')
