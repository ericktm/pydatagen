...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Field.size_max'
        db.add_column(u'app_field', 'size_max',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Field.regex'
        db.alter_column(u'app_field', 'regex', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):
        # Deleting field 'Field.size_max'
        db.delete_column(u'app_field', 'size_max')


        # Changing field 'Field.regex'
        db.alter_column(u'app_field', 'regex', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
