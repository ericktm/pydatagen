...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'ProjectFile.start_exec'
        db.add_column(u'app_projectfile', 'start_exec',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectFile.end_exec'
        db.add_column(u'app_projectfile', 'end_exec',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectFile.start_exec'
        db.delete_column(u'app_projectfile', 'start_exec')

        # Deleting field 'ProjectFile.end_exec'
        db.delete_column(u'app_projectfile', 'end_exec')
    ...
    models = {
        ...
        u'app.projectfile': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_exec': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'log': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [],
                        {'related_name': "'app_project_files_project'", 'to': u"orm['app.Project']"}),
            'start_exec': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
